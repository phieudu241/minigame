...
{
	/// <summary>
	/// Class for detecting string encoding
	...
	public class IdentifyEncoding
	{
		...
		// frequencies
		public static int[][] GBFreq = new int[94][];
		public static int[][] GBKFreq = new int[126][];
		public static int[][] Big5Freq = new int[94][];
		public static int[][] EUC_TWFreq = new int[94][];

		public static string[] nicename = new string[]
			{
        ...
        #region Instance
        private static IdentifyEncoding _instance;
        private static object _lockObj = new object();
        public static IdentifyEncoding Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (_lockObj)
                    {
                        if (_instance == null)
                        {
                            _instance = new IdentifyEncoding();
                        }
                    }
                }
		...
		public virtual string GetEncodingString(System.Uri testurl)
		{
			...
			{
                // 创建HttpWebRequest对象
                HttpWebRequest request = HttpWebRequestCreator.Create(testurl.AbsoluteUri);

                chinesestream = request.GetResponse().GetResponseStream();
		...
		public virtual int GB2312Probability(sbyte[] rawtext)
		{
			int i, rawtextlen = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int GBKProbability(sbyte[] rawtext)
		{
			int i, rawtextlen = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int HZProbability(sbyte[] rawtext)
		{
			int i, rawtextlen;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int BIG5Probability(sbyte[] rawtext)
		{
			int i, rawtextlen = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int ENCTWProbability(sbyte[] rawtext)
		{
			int i, rawtextlen = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int ISO2022CNProbability(sbyte[] rawtext)
		{
			int i, rawtextlen = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int UTF8Probability(sbyte[] rawtext)
		{
			int score = 0;
			int i, rawtextlen = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int UnicodeProbability(sbyte[] rawtext)
		{
			//int score = 0;
			//int i, rawtextlen = 0;
			//int goodbytes = 0, asciibytes = 0;
		...
		/// <param name="rawtext">要判断的 <see cref="sbyte"/> 字节数组</param>
		/// <returns>返回 0 至 100 之间的可能性</returns>
		public virtual int ASCIIProbability(sbyte[] rawtext)
		{
			int score = 70;
			int i, rawtextlen;
		...
		/// 初始化必要的条件
		/// </summary>
		public virtual void Initialize_Frequencies() 
		{
			int i;
			if(GBFreq[0] == null)
			{
